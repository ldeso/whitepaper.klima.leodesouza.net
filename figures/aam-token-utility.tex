...
\node[market=steel_teal] (bond) at (-3.5,0) {Time-locked\\Market};
...
\draw[connect=teal] (bond.east) -- node[pos=0.5, below, text=teal, font=\small\itshape] {Risky Cost of Capital}  (liquidity.west);
