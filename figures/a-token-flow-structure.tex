...
\node[carbon=steel_teal] (carbonin) at (-3.5,2.5) {Carbon Supply};
\node[carbon=blue_green] (carbonout) at (3.5,2.5) {Carbon Retirement};
...
\node[market=steel_teal] (Bonds) at (3.5,-2) {\A{} Time Locks};

% G Token Staking at bottom
\node[gtoken=peacock_blue] (gstaking) at (-3.5,-3.5) {\G{} User Lock};
