...
2. **Time-Locked Market**:
    ...
    weightings for time-locked **kVCM** holders in governance.
...
[not]{.underline} sell carbon credits.
...
3. **Investors**
    ...
    time-locking **kVCM** tokens called Base Accrual._
...
- **Adverse selection**:
    ...
    credits from its portfolio&nbsp;(only carbon offset certificates). 
