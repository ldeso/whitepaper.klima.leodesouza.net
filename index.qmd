...
#### Protocol Governance Signals {#sec-protocol-governance-signals}
...
otherwise there is no price, and the carbon cannot be sold.
...
balance, the amount of **A** tokens issued to pay for carbon, $\Delta A$,
...
class offset certificate of their choice $C_i$:
...
on a carbon supply and purchase round trip of a carbon offset certificate.
