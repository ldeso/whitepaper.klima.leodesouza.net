...
until a set date to define system parameters and to have the ability to select
...
the locked principal, hence the daily accrual for each duration is calculated:
