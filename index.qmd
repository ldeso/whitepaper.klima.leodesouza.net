...
1. **Carbon Suppliers & Retirees**
    ...
    _**Carbon Inventory**: Real-time execution terms for suppliers are
    continuously updated based on protocol token balances._
...
2. **Liquidity Providers**
    ...
    _**Staked Liquidity**: Provides continuous incentives for those contributing
    liquidity to the system._
...
3. **Governance Users**
    ...
    _**Time locks & user locks**: Provide continuous incentives for those
    contributing activities that coordinate the protocol._
